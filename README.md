...
[![Version](https://img.shields.io/badge/pod-1.3.4-blue.svg)](https://github.com/Boxzhi/HZPlaceHolder) [![Build Status](https://img.shields.io/badge/build-passing-green.svg)]()
...
```swift
dependencies: [
    .package(url: "https://github.com/Boxzhi/HZPlaceHolder.git", from: "1.3.4")
]
```
